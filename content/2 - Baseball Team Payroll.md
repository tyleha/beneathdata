...
In part based on the Blue Ribbon Panel's suggestions, the MLB instituted some changes in 2003, the biggest of which was the Luxury Tax. The Luxury Tax targeted the highest spending teams and provided a disincentive for overspending. The penalty was nontrivial – 17.5% of overages paid in tax, then 30%, 40%, and 50% for each year over the line.[ref]If this helps paint a picture, the entry for [Luxury Tax](http://en.wikipedia.org/wiki/Luxury_tax_(sports)) on Wikipedia has only one photo – a closeup of George Steinbrenner’s grumpy, wrinkly face.[/ref] To magnify the effect, these overage fees were paid out to the poorest teams, to effectively redistributing TV revenue, if you think about it. If we reexamine our above graph, you’ll notice a precipitous drop in value beginning roughly around 2003, coinciding with the institution of the Luxury Tax.

Other revenue sharing methods were put into play around the same time, including equal distribution of national TV contract revenue. Today, Salary Power in baseball is back to around its 1990 levels, according to my graph. Bud Selig can count that as a big victory for revenue sharing and competitive balance. And you, as a discerning baseball fan, can rest assured that balance has been returned to the league. 
